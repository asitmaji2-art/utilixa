        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-8 mb-12">
          <div>
            ...
            <ul className="space-y-2 text-xs text-slate-600 dark:text-slate-400 font-medium">
              <li>
                <Link href="/image-compressor" className="hover:text-cyan-500 transition-colors">
                  Image Compressor (Target KB)
                </Link>
              </li>
              <li>
                <Link href="/image-crop-zoom" className="hover:text-cyan-500 transition-colors">
                  Freeform Crop, Zoom & Rotate
                </Link>
              </li>
              <li>
                <Link href="/file-converter" className="hover:text-cyan-500 transition-colors">
                  Format Converter (WebP/PNG/JPG)
                </Link>
              </li>
              <li>
                <Link href="/color-palette-extractor" className="hover:text-cyan-500 transition-colors">
          ...
          <div>
            ...
            <ul className="space-y-2 text-xs text-slate-600 dark:text-slate-400 font-medium">
              <li>
                <Link href="/emi-calculator" className="hover:text-purple-500 transition-colors">
                  EMI Calculator in ₹ (INR)
                </Link>
              </li>
              <li>
                <Link href="/emi-calculator" className="hover:text-purple-500 transition-colors">
          ...
          <div>
            ...
            <ul className="space-y-2 text-xs text-slate-600 dark:text-slate-400 font-medium">
              <li>
                <Link href="/file-converter" className="hover:text-pink-500 transition-colors">
                  CSV to JSON / JSON to CSV
                </Link>
              </li>
              <li>
                <Link href="/pdf-compressor" className="hover:text-pink-500 transition-colors">
                  PDF Compressor to Target KB
                </Link>
              </li>
              <li>
                <Link href="/age-calculator" className="hover:text-pink-500 transition-colors">
                  Exact Age & Birthday Calculator
                </Link>
              </li>
              <li>
                <Link href="/qr-barcode-generator" className="hover:text-pink-500 transition-colors">
